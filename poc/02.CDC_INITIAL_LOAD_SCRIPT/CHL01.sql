...
execute task CDC.PUBLIC.CHL01_TABLE_INITIAL_TASK ;

SELECT * FROM TABLE(INFORMATION_SCHEMA.TASK_HISTORY(
    TASK_NAME => 'CHL01_TABLE_INITIAL_TASK'
     -- , ERROR_ONLY => TRUE 
...
CREATE OR REPLACE TASK CDC.PUBLIC.CHL01_TABLE_INITIAL_TASK
    WAREHOUSE = 'CDC_WH'
    SCHEDULE = NULL
AS
BEGIN
